...
const getPrices = async () => {
    const records = await pb.collection('prices').getFullList({sort: '-created',});
    let listPrs = [];
...
const CostSetting = () => {
    ...
    return (
        <div style={{flexBasis: "75%"}}>
            ...
            {form ? (
                <CostDetail item={itemSelected} typeData={typeData} timeData={timeData}
                            onBackClick={handleBackClick}></CostDetail>
            ) : addForm ? (
